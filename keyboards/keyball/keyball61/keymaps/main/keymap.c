...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    TD(TD_ESC_CAPS)   , LT(0,KC_NO)     , TG(1)     , KC_3     , KC_4     , KC_5     ,                                  KC_6     , KC_7     , KC_8     , KC_9     , KC_0     , KC_BSPC  ,
    ...
    KC_LEFT_SHIFT    , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , KC_LBRC  ,              KC_RBRC, KC_B     , KC_N     , KC_M  , KC_COMM   , KC_DOT  , KC_SLSH  ,
    KC_LCTL  , KC_LEFT_GUI  , KC_LALT  , KC_KP_PLUS,SCRL_MO	,KC_SPACE,KC_BTN1,    KC_BSPC,KC_LNG1,_______,_______, _______ , KC_RALT  , MO(3)
  ),
